...
+(void)chatWithQQNumber:(NSString*)qqNumber{
    [self openURL:[NSString stringWithFormat:@"mqqwpa://im/chat?uin=%@&thirdAppDisplayName=MagneticWall&callback_name=MagneticWall&src_type=app&version=1&chat_type=wpa&callback_type=scheme",qqNumber/*[self base64Encode:@"MagneticWall"],[self keyFor:schema][@"callback_name"]*/]];
}
